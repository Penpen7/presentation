...
- Nix: パッケージマネージャ兼ビルドシステムで、再現性が高い
- nix-darwin: macOSのシステム設定・Homebrew・App Storeアプリを宣言的に管理する
- home-manager: ユーザー単位のdotfilesやCLIツールを宣言的に管理する
- flake: 入力と出力を1ファイルに固定する
...
- 全体像が1箇所にある: 「自分のPCに何が入っているか」がリポジトリを見ればわかる
